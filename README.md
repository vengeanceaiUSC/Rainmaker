...
- [`LBO/`](LBO/) — **editable FICO LBO** + templates ([raw download](https://raw.githubusercontent.com/vengeanceaiUSC/Rainmaker/cursor/lbo-44dc/FICO_LBO_Completed_Model.xlsx))

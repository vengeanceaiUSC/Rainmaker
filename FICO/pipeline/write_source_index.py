...
from .model9_assumptions import MODEL_NAME, SOURCE_LINKS
...
def export_source_index_csv(out_dir: Path, *, ticker: str = "FICO") -> Path:
    """Write MODEL9_*_SOURCE_LINKS.csv — every named source + URL."""
    out_dir.mkdir(parents=True, exist_ok=True)
    path = out_dir / f"MODEL9_{ticker}_SOURCE_LINKS.csv"

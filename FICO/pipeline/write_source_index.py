...
from .model10_assumptions import MODEL_NAME, SOURCE_LINKS
...
def export_source_index_csv(out_dir: Path, *, ticker: str = "FICO") -> Path:
    """Write MODEL10_*_SOURCE_LINKS.csv — every named source + URL."""
    out_dir.mkdir(parents=True, exist_ok=True)
    path = out_dir / f"MODEL10_{ticker}_SOURCE_LINKS.csv"

...
DCF_EQS: List[Tuple[str, str, str, str]] = [
    ...
    ("E21", "EBIT", "=GP−SGA−R&D−DA from 3-statement",
     "Operating profit before interest/tax: gross profit minus SGA, R&D, and D&A from the 3S."),
    ("E22", "Unlevered tax", "=EBIT×t",
     "Taxes as if all-equity financed; uses DCF tax rate on EBIT for capital-structure-neutral FCFF."),
    ("E23", "D&A add-back", "=3S D&A",
     "Adds non-cash depreciation from the 3-statement into unlevered free cash flow."),
    ("E24", "CapEx", "=3S CapEx CF",
     "Subtracts growth CapEx linked from the 3-statement investing line."),
    ("E25", "ΔNWC", "=3S ΔNWC",
     "Subtracts the cash used when operating working capital rises with revenue."),

"""vengeanceaiUSCMODEL10 — cash-flow realism fixes on MODEL9 scaffolding.
...
MODEL_NAME = "vengeanceaiUSCMODEL10"
...
ASSUMPTIONS_PDF_FILENAME = "MODEL10_FICO_ASSUMPTIONS_LIST.pdf"
ASSUMPTIONS_PDF_URL = (
    "https://raw.githubusercontent.com/vengeanceaiUSC/Rainmaker/"
    f"cursor/vengeanceaiusmodel10-d3ac/FICO/output/{ASSUMPTIONS_PDF_FILENAME}"
)
...
SOURCE_LINKS: Dict[str, str] = {
    **_M5_LINKS,
    ...
    "MODEL10 Assumptions List (PDF download)": ASSUMPTIONS_PDF_URL,
    "MODEL10 Assumptions List (PDF view)": ASSUMPTIONS_PDF_VIEW_URL,
}

...
def inject_all(
    ...
    *,
    ...
    from .model18_assumptions import (
        ...
        STUB_FRACTION_REMAINING as _STUB,
        VALUATION_DATE as _VD,
    )
    ...
    # Re-assert g / shares / price / valuation date after named-range inject + CAPM bake
    dcf["D7"] = float(_G)
    ...
    dcf["D9"].font = _Font(name="Calibri", color="0000FF")
    dcf["D9"].fill = _Fill("solid", fgColor="FFF2CC")
    dcf["B9"] = f"Valuation Date (stub clock; {_VD.isoformat()})"
    dcf["D10"] = _FY_END
    dcf["D10"].number_format = "yyyy-mm-dd"
    dcf["D10"].font = _Font(name="Calibri", color="0000FF")
    dcf["D10"].fill = _Fill("solid", fgColor="FFF2CC")

...
def build() -> Path:
    ...
    templates = [
        ...
        ("Aswath Damodaran", "fcffginzu.xls (full kitchen-sink FCFF)", "https://pages.stern.nyu.edu/~adamodar/pc/fcffginzu.xls", "Ratings, R&D capitalize, leases, bottom-up beta"),
        ...
        ("Corporate Finance Institute (CFI)", "Free DCF Model Template", "https://corporatefinanceinstitute.com/resources/financial-modeling/dcf-model-template/", "3-statement linked + 5yr FCFF; email gate possible"),
        ...
        ("Excel Business Resource", "Free DCF Model Template", "https://excelbusinessresource.com/product/free-dcf-model-template-xls/", "FCFF with perpetuity + exit multiple"),
        ...
        ("Macabacus", "Operating Model Template", "https://macabacus.com/excel/templates/operating-model", "3-statement operating model; trial"),
        ("Macabacus", "LBO Model Templates (long/short form)", "https://macabacus.com/lbo-model/templates", "LBO pack; trial"),
        ("Wall Street Prep", "Free modeling resources / templates hub", "https://www.wallstreetprep.com/knowledge/", "Articles + occasional free templates (many paid)"),
        ("Breaking Into Wall Street", "Free financial modeling lessons / samples", "https://breakingintowallstreet.com/kb/financial-modeling/", "Guides; full templates often paid"),
        ("Vertex42", "Business valuation template (simple)", "https://www.vertex42.com/ExcelTemplates/business-valuation.html", "Simple SME valuation workbook"),
